...
def show_predict_page():
    ...
    st.info("###### 📚 This risk calculator was developed and validated using data from a multi-institutional cohort of 2,059 adult patients who underwent liver surgery between 2010 and 2023. (Model's AUC: 0.73)")
    ...
    cols3 = st.columns(2)
    Creatinine = cols3[0].number_input("Creatinine", 1, 9, 1)
    Total_bili = cols3[1].number_input("Total bilirubin", 1, 15, 1)
